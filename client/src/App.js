...
function App() {
  return (
    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="https://www.google.com/" class="navbar-link active" data-nav-link>Homepage</a>
          </li>

          <li class="navbar-item">
            <a href="https://www.google.com/" class="navbar-link" data-nav-link>Buy Crypto</a>
          </li>

          <li class="navbar-item">
            <a href="https://www.google.com/" class="navbar-link" data-nav-link>Markets</a>
          </li>
      ...
      <a href="https://www.google.com/" class="btn btn-outline">Wallet</a>
      ...
      <section class="section hero" aria-label="hero" data-section>
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <a href="https://www.google.com/" class="btn btn-primary">Get started now</a>
              ...
              <li>
                <div class="trend-card">
                  ...
                  <div class="card-title-wrapper">
                    ...
                    <a href="https://www.google.com/" class="card-title">
      ...
      <section class="section market" aria-label="market update" data-section>
        <div class="container">
          ...
          <div class="title-wrapper">
            ...
            <a href="https://www.google.com/" class="btn-link">See All Coins</a>
          </div>
                ...
                <tr class="table-row">
                  ...
                  <td class="table-data">
                    <div class="wrapper">
                      ...
                      <h3>
                        <a href="https://www.google.com/" class="coin-name">Bitcoin <span class="span">BTC</span></a>
                      </h3>
                    </div>
                  </td>
                ...
                <tr class="table-row">
                  ...
                  <td class="table-data">
                    <div class="wrapper">
                      ...
                      <h3>
                        <a href="https://www.google.com/" class="coin-name">Ethereum <span class="span">ETH</span></a>
                      </h3>
                    </div>
                  </td>
                ...
                <tr class="table-row">
                  ...
                  <td class="table-data">
                    <div class="wrapper">
                      ...
                      <h3>
                        <a href="https://www.google.com/" class="coin-name">Tether <span class="span">USDT/USD</span></a>
                      </h3>
                    </div>
                  </td>
                ...
                <tr class="table-row">
                  ...
                  <td class="table-data">
                    <div class="wrapper">
                      ...
                      <h3>
                        <a href="https://www.google.com/" class="coin-name">BNB <span class="span">BNB/USD</span></a>
                      </h3>
                    </div>
                  </td>
                ...
                <tr class="table-row">
                  ...
                  <td class="table-data">
                    <div class="wrapper">
                      ...
                      <h3>
                        <a href="https://www.google.com/" class="coin-name">Solana <span class="span">SOL</span></a>
                      </h3>
                    </div>
                  </td>
                ...
                <tr class="table-row">
                  ...
                  <td class="table-data">
                    <div class="wrapper">
                      ...
                      <h3>
                        <a href="https://www.google.com/" class="coin-name">XRP <span class="span">XRP</span></a>
                      </h3>
                    </div>
                  </td>
                ...
                <tr class="table-row">
                  ...
                  <td class="table-data">
                    <div class="wrapper">
                      ...
                      <h3>
                        <a href="https://www.google.com/" class="coin-name">Cardano <span class="span">ADA</span></a>
                      </h3>
                    </div>
                  </td>
                ...
                <tr class="table-row">
                  ...
                  <td class="table-data">
                    <div class="wrapper">
                      ...
                      <h3>
                        <a href="https://www.google.com/" class="coin-name">Avalanche <span class="span">AVAX</span></a>
                      </h3>
                    </div>
                  </td>
      ...
      <section class="section about" aria-label="about" data-section>
        <div class="container">
          ...
          <div class="about-content">
            ...
            <a href="https://www.google.com/" class="btn btn-primary">Explore More</a>
  ...
  <footer class="footer">
    ...
    <div class="footer-top" data-section>
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li>
            <a href="https://www.google.com/" class="footer-link">Spot</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Inverse Perpetual</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">USDT Perpetual</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Exchange</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Launchpad</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Binance Pay</a>
          </li>
        ...
        <ul class="footer-list">
          ...
          <li>
            <a href="https://www.google.com/" class="footer-link">Buy Crypto</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Markets</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Tranding Fee</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Affiliate Program</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Referral Program</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">API</a>
          </li>
        ...
        <ul class="footer-list">
          ...
          <li>
            <a href="https://www.google.com/" class="footer-link">Bybit Learn</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Help Center</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">User Feedback</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Submit a request</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">API Documentation</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Trading Rules</a>
          </li>
        ...
        <ul class="footer-list">
          ...
          <li>
            <a href="https://www.google.com/" class="footer-link">About Bybit</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Authenticity Check</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Careers</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Business Contacts</a>
          </li>

          <li>
            <a href="https://www.google.com/" class="footer-link">Blog</a>
          </li>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2022 Cryptex All Rights Reserved by <a href="https://www.google.com/" class="copyright-link">codewithsadee</a>
        </p>
